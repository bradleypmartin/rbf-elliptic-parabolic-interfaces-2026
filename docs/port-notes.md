...
| Diss. 5-16 = EABE 16 | control: error against time, backslash / gmres / bicgstab | `heat2d_iterative_performance.png` (first panel), `heat2d_iterative_iterations.png`, §2.8 | direct 0.04–0.7 s, gmres 0.012–3.5 s, bicgstab 0.02–1.2 s at 1.3e-3 → 1.4e-5 | direct 0.01–0.26 s, gmres 0.03–0.73 s, bicgstab 0.00–0.11 s at 2.21e-3 → 2.43e-5 | errors 1.0–1.7 (counts taken as 1250–20,000) | 3.3 / 3.25 |
